...
def main():
    ...
    while True:
        ...
        if ACTION.loc[s, a[0]][0] is 'S':    # shift t
            ...
            prod = ACTION.loc[s, a[0]][1:]   # Recebe o numero da produção
            stack.pop()                      # Desempilhe o simbulo B da pilha
            t = stack[-1]                    # Faça o estado t ser o topo da pilha
            stack.append(int(GOTO.loc[t, a[0]])) # Empilhe GOTO[t,A] na pilha
            print(produtions[int(prod)])         # Imprima a producao
